...
// 假设远程脚本定义了一个全局函数 remoteFunction
declare global {
    interface Window {
        embedChatbot: () => void;
        difyChatbotConfig: {
...
export default function Home() {
    const message = greet('Aling');

    React.useEffect(() => {
        window.difyChatbotConfig = {
            token: 'iibAUlQXBfzOaicC',
            baseUrl: 'http://192.168.186.39:8000'
        }
        loadScript('http://192.168.186.39:8000/embed.min.js')
            .then(() => {
